<?php
/*
* 4. Спроектируйте класс для работы со строками, класс должен иметь как публичные так и приватные методы, право решение какие методы какими делать стоит за вами, но хорошее правило делать приватными только те методы которые 
