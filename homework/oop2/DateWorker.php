<?php
// Написать класс для работы с временем, необходимо получать текущее время и выводить его в нескольких форматах. Форматы необходимо оформить как строковые константы.
